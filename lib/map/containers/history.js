...
var MapHistoryContainer = exports.MapHistoryContainer = function (_React$Component) {
    ...
    _createClass(MapHistoryContainer, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            var newDeviceID = nextProps.deviceID,
                newService = nextProps.service;
            var _props2 = this.props,
                oldDeviceID = _props2.deviceID,
                oldService = _props2.service;
        ...
        value: function render() {
            ...
            var _props3 = this.props,
                onZoomIn = _props3.onZoomIn,
                onZoomOut = _props3.onZoomOut,
                onMapLoad = _props3.onMapLoad,
                onCloseClick = _props3.onCloseClick;

            return _react2.default.createElement(
                'div',
                { className: 'mOSectionSideBySide' },
                _react2.default.createElement(_history2.default, _extends({
                    points: points,
                    center: center,
                    popup: popup,
