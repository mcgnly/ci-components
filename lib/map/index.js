    ...
    _createClass(MapContainer, [{
        ...
        value: function render() {
            if (this.state.type === 'history') {
                ...
                return _react2.default.createElement(_history2.default, _extends({}, this.props, { deviceID: historyDeviceId, service: this.service, onCloseClick: this.onHistoryClose }));
            } else {
                return _react2.default.createElement(_overview2.default, _extends({}, this.props, { service: this.service, featureInstruction: 'Show history', onPopupClick: this.onShowHistoryClick }));
            }
        }
    }]);
